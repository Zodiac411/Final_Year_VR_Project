...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class XRInput : MonoBehaviour {
        ...
        public static XRInput Instance {
            get {
                if (_instance == null) {
                    _instance = FindObjectOfType<XRInput>();
                    if (_instance == null) {
                        _instance = new GameObject("InputBridge").AddComponent<XRInput>();
                    }
                }
                return _instance;
            }
        }
        private static XRInput _instance;
    ...
    #pragma warning restore 0618
        ...
        void setDeviceProperties() {
            ...
            if(!string.IsNullOrEmpty(XRInput.Instance.GetControllerName())) 
            {
